...
export default function Admin({ onNavigate }: AdminProps) {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--bg-secondary)' }}>
      ...
      >
        <div className="p-6">
          <h2 className="font-serif text-lg font-bold mb-6" style={{ color: 'var(--text-primary)' }}>
            {t('admin.title')}
          </h2>
          ...
          <div className="mt-auto pt-6 border-t" style={{ borderColor: 'var(--border)' }}>
            <button
              ...
              className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium transition cursor-pointer text-red-500 hover:bg-red-50/10"
            >
              <LogOut size={18} />
              {lang === 'pt' ? 'Sair' : 'Logout'}
            </button>
      ...
      {/* Mobile Nav */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 overflow-x-auto"
        ...
        <div className="flex min-w-max px-2 py-2">
          {sidebarItems.map(item => (
            <button
              ...
              style={{
                color: activeTab === item.key ? 'var(--accent)' : 'var(--text-secondary)',
              }}
            >
              {item.icon}
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 px-4 py-2 text-xs font-medium cursor-pointer transition text-red-500"
          >
            <LogOut size={18} />
